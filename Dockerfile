...
COPY dist/nuvlaedge_common-latest-py3-none-any.whl /tmp/nuvlaedge_common-latest-py3-none-any.whl

RUN pip install /tmp/nuvlaedge_common-latest-py3-none-any.whl
